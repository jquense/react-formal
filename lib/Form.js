...
var _initialiseProps = function _initialiseProps() {
  ...
  this.handleValidate = function (path, _ref2) {
    ...
    options = _extends({}, options, { abortEarly: abortEarly, parent: parent, path: path });
    ...
    var pathValue = parent[currentPath] || value;

    return schema.validate(pathValue, options).then(function () {
      return null;
    }).catch(function (err) {
      return err;
    });
...
exports.default = (0, _uncontrollable2.default)(Form, { value: 'onChange', errors: 'onError' }, ['submit', 'validateGroup', 'validate']);
