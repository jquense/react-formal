...
function toErrors(err) {
  (0, _invariant2.default)(isValidationError(err), '`toErrors()` only works with ValidationErrors.');
...
var Form = function (_React$Component) {
  ...
  Form.prototype.render = function render() {
    ...
    var elementProps = (0, _omit2.default)(this.props, Object.keys(Form.propTypes));
    ...
    if (Element === null || Element === false) {
      children = _react2.default.cloneElement(_react2.default.Children.only(children), elementProps);
    } else {
...
Form.getter = getter;
Form.setter = setter;
Form.toErrors = toErrors;
Form.setDefaults = setDefaults;
Form.addInputTypes = _types2.default;
...
exports.default = (0, _hoistNonReactStatics2.default)((0, _uncontrollable2.default)(Form, {
  value: 'onChange',
  errors: 'onError'
}, ['submit', 'validateGroup', 'validate']), Form);
