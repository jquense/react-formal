...
var Form = (function (_React$Component) {
  ...
  Form.prototype._handleValidationRequest = function _handleValidationRequest(e) {
    ...
    this.timeout(e.field, function () {
      _this3.validator.validate(e.field, _this3.props).then(function () {
        return _this3.notify('onError', _this3.validator.errors());
      })['catch'](done);
    }, this.props.delay);
  };
  ...
  Form.prototype._flushValidations = function _flushValidations(newProps) {
    ...
    if (fields.length) {
      this.timeout('yup_flush_validations', function () {
        ...
        _this5.validator.validate(fields, newProps).then(function () {
          return _this5.notify('onError', _this5.validator.errors());
        })['catch'](done);
      }, newProps.delay);
    }
  };
