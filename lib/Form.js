...
Form.propTypes = {
   ...
   */
  component: _propTypes2.default.oneOfType([_propTypes2.default.func, _propTypes2.default.string, _propTypes2.default.oneOf([null, false])]),
  ...
  schema: function schema(props, name, componentName) {
    ...
    var err = !props.noValidate && (_PropTypes$any = _propTypes2.default.any).isRequired.apply(_PropTypes$any, [props, name, componentName].concat(args));
...
Form.contextTypes = {
  reactFormalContext: _propTypes2.default.object
};
