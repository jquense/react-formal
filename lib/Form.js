...
var _Validator = require('react-input-message/Validator');
...
var Form = function (_React$Component) {
  ...
  function Form(props, context) {
    ...
    _this._queue = [];
    _this._pathOptions = Object.create(null);
    _this._handleValidationRequest = _this._handleValidationRequest.bind(_this);

    _this._schema = _this._schema.bind(_this);
    _this.submit = _this.submit.bind(_this);
    _this.onError = function (errors) {
      return _this.notify('onError', errors);
    };
    ...
    _this._setPathOptions = function (path, options) {
      _this._pathOptions[path] = options;
    };

    _this.validator = new _Validator2.default(function (path, _ref) {
      var props = _ref.props;

      var model = props.value,
          schema = _this._schema(path, props),
      ...
      return schema.validate(value, _extends({}, props, options, { parent: parent, path: path })).then(function () {
        ...
        if (isValidationError(err)) return (0, _errToJSON2.default)(err);
        throw err;
      });
    });

    syncErrors(_this.validator, props.errors || {});
    return _this;
  }
  ...
  Form.prototype.componentWillUnmount = function componentWillUnmount() {
    ...
    for (var k in timers) {
      if (has(timers, k)) clearTimeout(timers[k]);
    }
  };
  ...
  Form.prototype.render = function render() {
    ...
    var containerProps = _props2.__messageContainer;
      ...
      _react2.default.createElement(
        ...
        _extends({
          ref: function ref(_ref2) {
            return _this2._container = _ref2;
          },
  ...
  Form.prototype._queueValidation = function _queueValidation(e) {
    this._queue = _paths2.default.reduce(uniq(this._queue.concat(e.fields)));
  };
  ...
  Form.prototype.notify = function notify(event) {
    ...
    this.props[event] && (_props4 = this.props)[event].apply(_props4, args);
  };
...
module.exports = (0, _uncontrollable2.default)(Form, { value: 'onChange', errors: 'onError' }, ['submit', 'validateGroup', 'validate']);
