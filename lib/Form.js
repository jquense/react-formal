...
var Form = function (_React$Component) {
  ...
  function Form(props, context) {
    ...
    _this.validator = new _Validator2.default(_this.handleValidate);
  ...
  Form.prototype.enqueue = function enqueue(fields) {
    this.queue = _paths2.default.reduce(uniq(this.queue.concat(fields)));
  };
  ...
  Form.prototype.notify = function notify(event) {
    ...
    this.props[event] && (_props3 = this.props)[event].apply(_props3, args);
  };
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.handleValidate = function (path, _ref2) {
    ...
    var model = props.value,
        options = _this4.pathOptions[path] || {},
        schema = _this4.getSchemaForPath(path, props),
        value = props.getter(path, model),
        parent = props.getter(getParent(path), model) || {};

    return schema.validate(value, _extends({}, props, options, {
      parent: parent,
      path: path
    })).then(function () {
      return undefined;
  ...
  this.handleNativeSubmit = function (e) {
