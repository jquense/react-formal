...
var Form = (function (_React$Component) {
  ...
  Form.prototype.render = function render() {
    ...
    return React.createElement(
      ...
      React.createElement(
        Element,
        babelHelpers._extends({}, props, { onSubmit: this.onSubmit }),
  ...
  Form.prototype.submit = function submit() {
    ...
    var options = babelHelpers.objectWithoutProperties(_props2, ['schema', 'value', 'debug']);
  ...
  Form.prototype._listenerContext = function _listenerContext(props) {
    return {
      ...
      value: function value(path) {
        return props.getter(path, props.value);
      } };
  };
