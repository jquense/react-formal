...
var Field = function (_React$Component) {
  ...
  Field.prototype.render = function render() {
    ...
    var props = _objectWithoutProperties(_props, ['events', 'group', 'mapValue', 'mapFromValue', 'name', 'type', 'exclusive', 'alsoValidates', 'valueAccessor', 'mapToValue', 'errorClass', 'recursive']);
