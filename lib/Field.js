...
function chainEvents(events, props, bindingProps, triggerProps) {
  ...
  events.forEach(function (event) {
    result[event] = (0, _chainFunction2.default)(props[event], bindingProps[event], triggerProps[event]);
  });
  return result;
}
...
var Field = function (_React$Component) {
  ...
  function Field() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.bindTo = function (_value, getter) {
      ...
      var props = _extends({
        name: name
      }, (0, _omit2.default)(_this.props, Object.keys(Field.propTypes)), bindingProps, triggerProps, chainEvents(events, _this.props, bindingProps, triggerProps));
      ...
      if (_this.shouldValidate()) {
        ...
        props.className = (0, _classnames2.default)(className, invalid && errorClass);
      ...
      if (type === null && typeof children === 'function') {
        props.schema = _this.schema(name);
