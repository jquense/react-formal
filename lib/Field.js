...
var Field = function (_React$Component) {
  ...
  Field.prototype.render = function render() {
    ...
    var recursive = _props.recursive;

    var props = _objectWithoutProperties(_props, ['events', 'group', 'mapValue', 'mapFromValue', 'name', 'type', 'exclusive', 'valueAccessor', 'mapToValue', 'errorClass', 'alsoValidates', 'recursive']);
