...
var Field = function (_React$Component) {
  ...
  function Field() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.bindTo = function (value, getter) {
      ...
      var getValue = mapToValue || valueAccessor || getter.bind(null, name);
  ...
  Field.prototype.render = function render() {
    ...
    var valueAccessor // eslint-disable-line
    = _props.valueAccessor;

    var props = _objectWithoutProperties(_props, ['events', 'group', 'mapValue', 'mapFromValue', 'name', 'type', 'exclusive', 'valueAccessor']);
...
Field.propTypes = {
   ...
   * ```
   */
  mapToValue: _react2.default.PropTypes.func,
