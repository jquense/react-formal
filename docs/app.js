...
var routes = (
  <Route name="app" path="/" component={App}>
    ...
    <Route path="api" component={Docs}>
      <IndexRoute
        component={require('!babel-loader!./loaders/jsx!./loaders/metadata!../src/Form')}
      />
      ...
      <Route
        path="field"
        component={require('!babel-loader!./loaders/jsx!./loaders/metadata!../src/Field')}
      />
      <Route
        path="message"
        component={require('!babel-loader!./loaders/jsx!./loaders/metadata!../src/ValidationMessage')}
      />
      <Route
        path="summary"
        component={require('!babel-loader!./loaders/jsx!./loaders/metadata!../src/ValidationSummary')}
      />
      <Route
        path="button"
      ...
      <Route
        path="context"
        component={require('!babel-loader!./loaders/jsx!./loaders/metadata!../src/FormContext')}
      />
      <Route
        path="/controllables"
        component={require('./pages/controllables.md')}
      />
    </Route>
  </Route>
)
